...
/*! brief  Return Frequency of I3C
 *  return Frequency of I3C
 */
uint32_t CLOCK_GetI3cClkFreq(void)
{
    ...
    divider = SYSCON->I3CCLKDIV & SYSCON_I3CCLKDIV_I3C_FCLK_DIV_MASK;
